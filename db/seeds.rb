...
user1 = User.create!(email: 'studenthome@email.com', password: 'learner', created_at: '2016-05-25 10:00:35', updated_at: '2016-06-20 11:44:35', position: 'student', roles: 'standard')
...
stud1 = Student.create(student_id: '1234567', last_name: 'jacobs', first_name: 'boxer', home_address: '257 Discovery road' ,home_city: 'Rockford' ,home_state: 'Illinois',
    ...
    cell_phone: '9856243571', new_student: '0', returning_student: '1', athletic_team: 'NULL', user_id: user1.id, created_at: '2016-05-25 10:00:35', updated_at: '2016-06-20 11:44:35')
...
ec2 = EmergencyContact.create(last_name: 'Ryan', first_name: 'Sam', address: '567 Construction St', city: 'Lake Forest' , state: 'Illinois', zip: '64126', home_phone: '3313568794',
    cell_phone: '3315648925', office_phone: 'NULL', student_id: stud2.id, user_id: user3.id, created_at: '2015-04-3 12:54:35', updated_at: '2015-12-3 10:54:35' )
ec3 = EmergencyContact.create(last_name: 'Smith', first_name: 'Alan', address: '124 Place St', city: 'Anywheresville', state: 'Pennsylvania', zip: '12344', home_phone: '8794856411',
...
pe2 = VehiclePermit.create(vehicle_permit_id: '38567', date_issued: '2017-08-25 10:20:42', issued_by: 'Paul', date_entered: '2017-08-25',
    entered_by: stud2.first_name + ' ' + stud2.last_name, user_id: user3.id, created_at: '2017-08-25 10:20:41', updated_at: '2017-08-25 10:20:42')
pe3 = VehiclePermit.create(vehicle_permit_id: '94832', date_issued: '2017-12-4 11:50:00', issued_by: 'Sandy', date_entered: '2017-12-4',
...
vh2 = Vehicle.create(year: '2014', color: 'blue', make: 'Lexus', model: 'IS', license_number: 'M35486514', state_licensed: 'IL',
     experation_year: '2025', vehicle_permit_id: pe2.vehicle_permit_id, student_id: stud2.student_id, user_id: user3.id, created_at: '2012-08-25 10:00:35', updated_at: '2017-08-20 11:44:35')
vh3 = Vehicle.create(year: '2017', color: 'green', make: 'Buick', model: 'Bearclaw', license_number: 'Q12386514', state_licensed: 'IL',
